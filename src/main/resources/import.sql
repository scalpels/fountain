...
create table topic (id bigserial  primary key, title varchar(30), description varchar(30),created_by varchar(30),created_on timestamp,last_modified_on timestamp,last_modified_by varchar(30));
